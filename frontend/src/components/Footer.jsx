...
export default function App() {
  ...
  return (
    <footer className="bg-neutral-900 text-center text-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 lg:text-left">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        <div className="mr-12 hidden lg:block">
          <span>Nos encontre em outras redes sociais:</span>
        </div>
        ...
        <div className="flex justify-center">
          ...
          <a className="text-neutral-600 dark:text-neutral-200">
            <a href="https://github.com/ICEI-PUC-Minas-PMV-SI/pmv-si-2024-1-pe3-t2-estore">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* <!-- Products section --> */}
          <div className="">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Produtos</h6>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Camisas</a>
            </p>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Camisetas</a>
            </p>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Casacos</a>
            </p>
            <p>
              <a className="text-neutral-600 dark:text-neutral-200">Moletons</a>
            </p>
          </div>
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-black p-6 text-center dark:bg-neutral-800">
